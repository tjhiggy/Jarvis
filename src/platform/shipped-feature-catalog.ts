...
export const shippedFeatureCatalog = [
  ...
  },
  {
    ...
    requiredConfiguration: [],
    permissionBoundary:
      'Any guild member can post one public bird call in the current channel. Direct messages fail closed. Role mentions in optional game text stay intact with matching allowedMentions.roles, except the @everyone role (guild id) which is neutralized; mass, user, and channel mentions stay neutralized. Default invites keep empty allowedMentions.',
    persistenceBehavior:
