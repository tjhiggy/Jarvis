...
<title>MuthaShip Command Deck</title><style>
:root{color-scheme:dark;--void:#070611;--panel:#151126;--panel2:#21183b;--line:#5d3aa3;--gold:#f6c85f;--violet:#c09cff;--blue:#78c8ff;--text:#faf7ff;--muted:#b8b0cc;--ok:#72efb0;--magenta:#e072d4}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 85% -10%,#49227a 0,#16102d 35%,var(--void) 72%);color:var(--text);font:16px system-ui,-apple-system,Segoe UI,sans-serif;min-height:100vh}main{max-width:1040px;margin:0 auto;padding:40px 24px 56px}header{display:flex;align-items:center;gap:16px;margin-bottom:28px}header .crest{font-size:38px;filter:drop-shadow(0 0 14px #c05cffaa)}h1{margin:0;color:var(--gold);font-size:clamp(28px,5vw,42px);letter-spacing:.03em;text-shadow:0 0 18px #8b4dff66}h2{margin:0 0 12px;color:var(--violet);font-size:20px}.subtitle{margin:4px 0 0;color:var(--muted)}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(270px,1fr));gap:18px}.card{background:linear-gradient(145deg,#241843ee,#110d20ee);border:1px solid var(--line);border-radius:16px;padding:20px;box-shadow:0 12px 34px #0008;transition:border-color .2s,transform .2s}.card:hover{border-color:var(--magenta);transform:translateY(-2px)}.ok{color:var(--ok)}.muted{color:var(--muted)}ul{padding-left:20px}small{color:#9f92bc;overflow-wrap:anywhere}button{border:1px solid #865de0;background:#39246e;color:var(--text);border-radius:8px;padding:9px 13px;font:inherit;cursor:pointer;margin:4px 6px 4px 0}button:hover,button:focus-visible{background:#6542ad;outline:2px solid var(--blue);outline-offset:2px}input{background:#0e0a19;border:1px solid #7250aa;border-radius:8px;color:var(--text);padding:9px 10px;font:inherit;max-width:100%}@media(max-width:520px){main{padding:24px 16px 40px}.card{padding:16px}}
