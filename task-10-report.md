...
Shutdown stops schedulers before closing SQLite, and scheduler errors are projected to safe structured metadata. Owner deletion stays guild-scoped; administrators may delete a selected member's retained engagement records.
