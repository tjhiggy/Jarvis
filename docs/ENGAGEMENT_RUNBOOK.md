...
| `/bird-call [game]`                                           | Any member can post one public MuthaShip-voice invite asking who wants to game now. Optional `game` names the activity. Guild channels only; direct messages fail closed. Mentions stay neutralized. It does not use the activity-channel gate and does not replace `/lfg` or `/game-night`.                                                                                                                                                                                                  |
