...
| `/daily`                                                      | v0.9 implementation slice. Any member may claim one bounded 10-coin reward per server day. The claim is server/member/day unique, stores no message content, honors engagement opt-out, and remains unreleased until the slice smoke test and tagged release are complete.                                                                                                                                                                                                                    |
| `/streak`                                                     | v0.9 implementation slice. Shows the server-scoped current and longest UTC-day participation streak, advanced by successful daily participation and suppressed for opted-out members. |
