...
The current V1 production source remains the checked-in FAQ catalog. Channel and thread ingestion, administrator preview/approval UI, member removal requests, and audit records are deliberately separate follow-up work. They must be implemented before Discord content is eligible for indexing.
