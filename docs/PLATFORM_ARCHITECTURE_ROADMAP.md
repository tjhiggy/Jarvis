...
| 1.6     | Sites Command Deck                | Packaged as `v1.6.0`. Private Sites operator console with live snapshot, bounded controls, local fallback, and cutover verification. The operator publishes the owner-only URL.     |
