...
| 0.5     | Shipboard Broadcasts      | Release package prepared: RSS, approved proactive posts, recaps, event reminders, birthday mentions, quiet hours, cadence limits, honest preferences, previews, pause/resume, lease fencing, and durable deduplication. Publication remains maintainer-owned. |
...
| 0.9     | Crew Engagement           | Planned. Member profiles, MuthaShip Coins and daily rewards, participation streaks, game roles, persistent teams, and Command Deck engagement visibility. Each module remains opt-in, server-scoped, and independently disableable.                           |
