...
| `/event create`, `list`, `details`, `cancel`; `/game-night create`, `list`; `/lfg` | Member / administrator | Guided public workflow              | Both                                   | Discord owns participation; Deck owns configuration, scheduling health, and bulk recovery.                                                                                             |
